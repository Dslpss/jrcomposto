      ...
      <div className="relative mx-auto grid min-h-screen w-full max-w-6xl grid-cols-1 px-6 py-10 md:grid-cols-2 md:gap-10 md:px-10 md:py-16">
        ...
        <div className="order-2 hidden flex-col justify-center md:order-1 md:flex">
          <div className="space-y-4">
            ...
            <p className="max-w-md text-zinc-300">
              Cadastre-se para começar a salvar múltiplos cenários de juros
              compostos, acessíveis em qualquer lugar.
            </p>
          </div>
        </div>
        ...
        <div className="order-1 flex items-center justify-center md:order-2">
          <form
            ...
            className="w-full max-w-md rounded-2xl border border-white/10 bg-white/5 p-6 shadow-2xl backdrop-blur-md md:p-8"
          >
            <div className="mb-6">
              <div className="flex items-center gap-2">
                <div className="h-9 w-9 rounded-lg bg-linear-to-br from-emerald-400 to-cyan-400" />
                <div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute inset-y-0 right-2 my-auto inline-flex h-8 w-8 items-center justify-center rounded-md text-zinc-300 hover:bg-white/10 hover:text-white"
                  >
                    {showPassword ? (
                      // Ícone olho aberto
                      <svg
              ...
              {ok && (
                <p className="text-sm text-emerald-300">
                  Cadastro realizado! Você já pode{" "}
              ...
              <button
                disabled={loading}
                className="group relative mt-2 w-full overflow-hidden rounded-lg bg-linear-to-br from-emerald-500 to-cyan-500 px-3 py-2 font-medium text-white shadow-lg transition enabled:hover:brightness-110 disabled:opacity-60"
              >
